...
const combinacoesButton = document.addEventListener("DOMContentLoaded", function () {
  var toggleButton = document.querySelector(".combinacoes-toggle");
...
const acaiZeroButton = document.addEventListener("DOMContentLoaded", function () {
  var toggleButton = document.querySelector(".acaiZero-toggle");
...
const milkShakeButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.milkshake-toggle');
...
const saladaButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.salada-toggle');
...
const bolosButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.bolos-toggle');
...
const sobremesaButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.sobremesa-toggle');
...
const brownieButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.brownie-toggle');
...
const bebidasButton = document.addEventListener('DOMContentLoaded', function() {
  var toggleButton = document.querySelector('.bebidas-toggle');
